...
"""
This script is used for visual inspection of the observation data, black-body fitting results, 
and the performance of the spectral energy distribution (SED) fitting.
Users can input the starID of the target star, and the script will load the relevant data files 
and generate images to help understand the fitting process and results.
"""
...
# load Isochrone fitting output
pho_isocm = pd.read_csv(combined_data_isochronefit_path+"Output_Isochrone_Fits.csv", dtype={"starID":str})
print("\n\n\n")
print("(3) ===================================================================================================")
print("Isochrone fitting output:")
print(pho_isocm[pho_isocm.starID==str(starID)])
...
# load isochrone fit
fig, ax = plt.subplots(1,1)
img=mpimg.imread(fig_isochronefit_path + starID +".png")
ax.imshow(img)
