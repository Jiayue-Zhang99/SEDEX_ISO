...
Derived from: [astroARIADNE](https://github.com/jvines/astroARIADNE.git)
"""
...
def estimate(bands, params, logg=True, out_folder='.'):
    ...
    # set bayesian priors for distance
    model._priors['distance'] = GaussianPrior(dist, dist_e)
    # use dynesty to sample the posterior, and run the bayesian fitting
    ...
    ###########################################################################
    # return the median and error of logg of fitting results
    if logg:
