...
###################################################################################################################################### 
gaia_user_name = "zjiayue"                                              # Gaia user name.
gaia_user_password = "Eld98288707!"                                     # Gaia user password
...
# These paths are used in the following modules: 4_BlackBodyFit.py, 6_SedFit.py, 9_IsochroneFit.py
...
# Define the corresponding model path based on the selected spectral grid model
if grid == "MARCS": grid_spectrum_path = "../../SEDEX-master/marcs/marcs_st_flx/"#"../marcs/marcs_st_flx/"
...
# define the paths for saving results from Blackbody fitting
...
# control how to estimate posterior-weighted mean and uncertainties.
...
if __name__ == '__main__':
    ...
    if not os.path.isdir(fig_isochronefit_path): os.system("mkdir -p " + fig_isochronefit_path)
