...
"""
This script is to collect and combine the blackbody fitting results for all the stars, and save them as a single table file (CSV file).
The blackbody fitting results include the extinction (A_v), effective temperature (T_eff), scaling factor (f_0), and reduced chi-square (\chi^2_{\rm red}) etc.

Output table of blackbody fits (Output_BlackBody_Fits.csv):
    •	starID: the unique identifier of the star.
    •	Qflg: the quality flag of the photometric points.
    •	A_v: the extinction.
    •	ScaleF: the scaling factor.
    •	ScaleFerr: the error of the scaling factor.
    •	T_{eff}: the effective temperature.
    •	Tefferr: the error of the effective temperature.
    •	RedChi: the reduced chi-square.
"""
